...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{image_model/model_text.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{image_model/model_audio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{image_model/model_video.png}

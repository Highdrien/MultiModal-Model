...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{image_model/model_transformers.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{image_model/model_text.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{image_model/model_audio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{image_model/model_video.png}

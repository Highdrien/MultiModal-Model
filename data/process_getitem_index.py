...
def process_text_index(file: str, data_path: Optional[str] = "data") -> Dict[str, list]:
    """
...
def process_index_video(
    ...
    for n_speaker in range(len(speakers)):
        ...
        filename = os.path.join(
            data_path, f"{dataset}_{file}_{speakers[n_speaker]}.csv"
        )
